...
def main() -> None:
    ...
    out_path = os.path.join(OUT_DIR, "baseline_llama3_only.json")
    summary_path = os.path.join(OUT_DIR, "baseline_llama3_only_summary.json")
