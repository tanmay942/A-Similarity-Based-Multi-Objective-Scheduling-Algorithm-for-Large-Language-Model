...
MODELS = ["llama3", "phi3", "mistral","qwen2.5:3b-instruct"]
...
def main() -> None:
    ...
    out_path = os.path.join(OUT_DIR, "baseline_qwen_only.json")
    summary_path = os.path.join(OUT_DIR, "baseline_qwen_only_summary.json")
